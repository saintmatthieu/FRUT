...
function(_FRUT_set_compiler_and_linker_settings_APPLE target)
  ...
  elseif(CMAKE_GENERATOR STREQUAL "Xcode")
    ...
    foreach(config IN LISTS JUCER_PROJECT_CONFIGURATIONS)
      ...
      if(target MATCHES "_AUv3_AppExtension$"
          AND osx_deployment_target VERSION_LESS 10.15)
        set(osx_deployment_target "10.15")
        message(STATUS "Set OSX Deployment Target to 10.15 for ${target} in ${config}")
      endif()
    ...
    if(target MATCHES "_AUv3_AppExtension$" AND osx_deployment_target VERSION_LESS 10.15)
      set(osx_deployment_target "10.15")
      message(STATUS "Set OSX Deployment Target to 10.15 for ${target}")
    endif()
    target_compile_options(${target} PRIVATE
